...
public record TaskVm(Guid Id, string Title, string? Description, DateTime CreatedDate, DateTime StartDate, DateTime EndDate, TODOTaskStatus Status, decimal TotalHours);
